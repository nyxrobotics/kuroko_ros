#ifndef KUROKO_WALKING_GUI_PREVIEW_WALKING_FORM_H
#define KUROKO_WALKING_GUI_PREVIEW_WALKING_FORM_H
...
public:
  explicit PreviewWalkingForm(QWidget* parent = nullptr);
  ~PreviewWalkingForm() override;

  bool setQNode(walking_gui::QNodeKuroko* qnode);
  bool init(walking_gui::QNodeKuroko* qnode);
...
private:
  Ui::PreviewWalkingForm* p_walking_ui_;
  walking_gui::QNodeKuroko* qnode_kuroko_;
...
#endif  // KUROKO_WALKING_GUI_PREVIEW_WALKING_FORM_H
