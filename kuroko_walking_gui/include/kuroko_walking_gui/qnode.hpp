#ifndef KUROKO_WALKING_GUI_QNODE_HPP_
#define KUROKO_WALKING_GUI_QNODE_HPP_
#ifndef Q_MOC_RUN
...
class QNodeKuroko : public QThread
{
  Q_OBJECT
public:
  enum LogLevel
  ...
  QNodeKuroko(int argc, char** argv);
  virtual ~QNodeKuroko() override;
  ...
  void log(const LogLevel& level, const std::string& msg, const std::string& sender = "Demo");
  void clearLog();
  void assembleLidar();
  ...
  void initDefaultDemo(ros::NodeHandle& ros_node);
  // Head control
...
#endif /* KUROKO_WALKING_GUI_QNODE_HPP_ */
