#ifndef KUROKO_ONLINE_WALKING_MODULE_WALKING_CONTROL_
#define KUROKO_ONLINE_WALKING_MODULE_WALKING_CONTROL_
...
public:
  WalkingControl(double control_cycle, double dsp_ratio, double lipm_height, double foot_height_max,
                 double zmp_offset_x, double zmp_offset_y, std::vector<double_t> x_lipm, std::vector<double_t> y_lipm,
