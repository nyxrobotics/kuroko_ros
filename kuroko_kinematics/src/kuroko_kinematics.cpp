...
KurokoKinematics::KurokoKinematics(TreeSelect tree)
{
  ...
  if (tree == WHOLE_BODY)
  {
    ...
    joint_link_tree_[12]->child_ = 13;  // knee_r_rear
    ...
    joint_link_tree_[13]->name_ = "knee_r_rear";
    joint_link_tree_[13]->parent_ = 12;   // hip_r_pitch
    joint_link_tree_[13]->sibling_ = 20;  // shin_r_rear
    ...
    joint_link_tree_[14]->parent_ = 13;  // knee_r_rear
    ...
    joint_link_tree_[14]->joint_mimic_ = "knee_r_rear";
    ...
    joint_link_tree_[15]->joint_mimic_ = "shin_r_rear";
    ...
    joint_link_tree_[16]->joint_mimic_ = "shin_r_rear";
    ...
    joint_link_tree_[20]->name_ = "shin_r_rear";
    ...
    joint_link_tree_[21]->parent_ = 20;  // shin_r_rear
    ...
    joint_link_tree_[21]->joint_mimic_ = "shin_r_rear";
    ...
    joint_link_tree_[22]->joint_mimic_ = "knee_r_rear";
    ...
    joint_link_tree_[23]->joint_mimic_ = "knee_r_rear";
    ...
    joint_link_tree_[24]->joint_mimic_ = "shin_r_rear";
    ...
    joint_link_tree_[26]->child_ = 27;  // knee_l_rear
    ...
    joint_link_tree_[27]->name_ = "knee_l_rear";
    joint_link_tree_[27]->parent_ = 26;   // hip_l_pitch
    joint_link_tree_[27]->sibling_ = 34;  // shin_l_rear
    ...
    joint_link_tree_[28]->parent_ = 27;  // knee_l_rear
    ...
    joint_link_tree_[28]->joint_mimic_ = "knee_l_rear";
    ...
    joint_link_tree_[29]->joint_mimic_ = "shin_l_rear";
    ...
    joint_link_tree_[30]->joint_mimic_ = "shin_l_rear";
    ...
    joint_link_tree_[34]->name_ = "shin_l_rear";
    ...
    joint_link_tree_[35]->parent_ = 34;  // shin_l_rear
    ...
    joint_link_tree_[35]->joint_mimic_ = "shin_l_rear";
    ...
    joint_link_tree_[36]->joint_mimic_ = "knee_l_rear";
    ...
    joint_link_tree_[37]->joint_mimic_ = "knee_l_rear";
    ...
    joint_link_tree_[38]->joint_mimic_ = "shin_l_rear";
  ...
  leg_side_offset_ = 2.0 * (std::fabs(joint_link_tree_[getLinkIndex("hip_r_roll")]->joint_position_.coeff(1, 0) +
                                      ...
                                      joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_position_.coeff(1, 0)));
  // Vertical length from sole center to waist center when standing upright
  leg_max_height_ = std::fabs(joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_position_.coeff(2, 0) +
                                                         ...
                                                         std::vector<double> target_pose_in)
{
  ...
  double hip_pitch_to_thigh_upper_z = joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_position_.coeff(2, 0);
  ...
  double shin_pitch_joint =
      ...
      (shin_pitch - robotis_framework::convertRotationToRPY(
                        ...
                        .coeff(1, 0));
  double thigh_pitch_joint = joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_axis_.coeff(1, 0) *
                             (thigh_pitch - robotis_framework::convertRotationToRPY(
                                                joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_orientation_)
                                                .coeff(1, 0));
  ...
  thigh_pitch_joint =
      std::max(std::min(thigh_pitch_joint, joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_limit_upper_),
               joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_limit_lower_);
  shin_pitch_joint =
  ...
  shin_active_joint =
      std::max(std::min(shin_active_joint, joint_link_tree_[getLinkIndex("shin_r_rear")]->joint_limit_upper_),
               joint_link_tree_[getLinkIndex("shin_r_rear")]->joint_limit_lower_);
  joints_out.resize(6);
                                                        ...
                                                        std::vector<double> target_pose_in)
{
  ...
  // Define link lengths based on the robot's dimensions
  double hip_roll_to_pitch_offset_y = leg_side_offset_ / 2.0;
  double hip_pitch_to_thigh_upper_z = joint_link_tree_[getLinkIndex("knee_l_rear")]->joint_position_.coeff(2, 0);
  ...
  double shin_pitch_joint =
      ...
      (shin_pitch - robotis_framework::convertRotationToRPY(
                        ...
                        .coeff(1, 0));
  double thigh_pitch_joint = joint_link_tree_[getLinkIndex("knee_l_rear")]->joint_axis_.coeff(1, 0) *
                             (thigh_pitch - robotis_framework::convertRotationToRPY(
                                                joint_link_tree_[getLinkIndex("knee_l_rear")]->joint_orientation_)
                                                .coeff(1, 0));
  ...
  thigh_pitch_joint =
      std::max(std::min(thigh_pitch_joint, joint_link_tree_[getLinkIndex("knee_l_rear")]->joint_limit_upper_),
               joint_link_tree_[getLinkIndex("knee_l_rear")]->joint_limit_lower_);
  shin_pitch_joint =
  ...
  shin_active_joint =
      std::max(std::min(shin_active_joint, joint_link_tree_[getLinkIndex("shin_l_rear")]->joint_limit_upper_),
               joint_link_tree_[getLinkIndex("shin_l_rear")]->joint_limit_lower_);
  joints_out.resize(6);
  joints_out[0] = hip_roll_joint;
  joints_out[1] = hip_pitch_joint;
  joints_out[2] = thigh_pitch_joint;
                                                         ...
                                                         std::vector<double>& target_pose_out)
{
  ...
  double hip_pitch =
      ...
      robotis_framework::convertRotationToRPY(joint_link_tree_[getLinkIndex("hip_r_pitch")]->joint_orientation_)
          .coeff(1, 0);
  double thigh_pitch =
      (thigh_pitch_joint / joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_axis_.coeff(1, 0)) +
      robotis_framework::convertRotationToRPY(joint_link_tree_[getLinkIndex("knee_r_rear")]->joint_orientation_)
          .coeff(1, 0);
  double shin_pitch =
                                                        ...
                                                        std::vector<double>& target_pose_out)
{
  ...
  double hip_pitch =
      ...
      robotis_framework::convertRotationToRPY(joint_link_tree_[getLinkIndex("hip_l_pitch")]->joint_orientation_)
          .coeff(1, 0);
  double thigh_pitch =
      (thigh_pitch_joint / joint_link_tree_[getLinkIndex("knee_l_rear")]->joint_axis_.coeff(1, 0)) +
      robotis_framework::convertRotationToRPY(joint_link_tree_[getLinkIndex("knee_l_rear")]->joint_orientation_)
          .coeff(1, 0);
  double shin_pitch =
