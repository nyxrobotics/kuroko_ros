...
double BalanceLowPassFilter::getCutOffFrequency()
{
...
{
  balance_control_error_ = BalanceControlError::NO_ERROR;
  control_cycle_sec_ = 0.008;
                                                  ...
                                                  Eigen::MatrixXd* robot_to_left_foot_modified)
{
  ...
  if ((fabs(pose_cob_adjustment_.coeff(0)) == cob_x_adjustment_abs_max_m_) ||
    ...
    balance_control_error_ &= BalanceControlError::BALANCE_LIMIT;
...
double BalanceControlUsingDampingConroller::getGyroBalanceGainRatio()
{
