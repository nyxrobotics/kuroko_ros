...
#ifndef KUROKO_BALANCE_CONTROL_KUROKO_BALANCE_CONTROL_H_
#define KUROKO_BALANCE_CONTROL_KUROKO_BALANCE_CONTROL_H_
...
public:
  ...
  static const int BALANCE_LIMIT = 2;
};
...
public:
  ...
  double getGyroBalanceGainRatio();
